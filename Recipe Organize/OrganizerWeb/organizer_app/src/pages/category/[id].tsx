...
import { ApiGetDishByCategory, ApiGetDishById } from '@/services/DishService';
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const dishDataBody = await ApiGetDishByCategory(id,mPage,mSize) as JsonBody;
    const dishData = dishDataBody.data as Dish[];
    const urlCurrent = Constant.URL_FONTEND+"/category/"+params?.id;
    return { 
        props: { 
            tagData, 
            categoryData,
